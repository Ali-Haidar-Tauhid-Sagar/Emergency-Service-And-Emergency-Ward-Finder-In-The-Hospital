        ...
        if($count>0){
            ...
            <table>
                ...
                <tr <?php if($row['icu_aval']=="no") echo "hidden" ?> >
                    ...
                    <td><button class="button" <?php if($row['icu_quantity']=="0") echo "disabled" ?> data-id="ICU" onclick="booking(this)" >Book</button> </td>
				</tr>
                <tr <?php if($row['ccu_aval']=="no") echo "hidden" ?> >
                    <td>CCU</td>
                    <td><?php echo $row['ccu_rate'] ?></td>
                    <td><?php if($row['ccu_quantity']=="0") { 
                                echo '<p class="alert alert-danger" role="alert"><b>Not Available</b></p>';
                              }else{
                                echo '<p class="alert alert-success" role="alert"><b>Available</b></p>';
                              }  ?></td>
                    <td><button class="button" <?php if($row['ccu_quantity']=="0") echo "disabled" ?> data-id="CCU" onclick="booking(this)" >Book</button> </td>
				</tr>

                <tr <?php if($row['single_aval']=="no") echo "hidden" ?> >
                    <td>Emergency ward</td>
                    <td><?php echo $row['single_rate'] ?></td>
					<td><?php if($row['single_quantity']=="0") { 
                                echo '<p class="alert alert-danger" role="alert"><b>Not Available</b></p>';
                              }else{
                                echo '<p class="alert alert-success" role="alert"><b>Available</b></p>';
                              }  ?></td>
                    <td><button class="button" <?php if($row['single_quantity']=="0") echo "disabled" ?> data-id="Emergency ward" onclick="booking(this)" >Book</button> </td>
                </tr>
