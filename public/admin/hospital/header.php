    ...
    <div class="sidebar" data-color="blue" data-image="assets/img/sidebar-5.jpg">
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="<?php if($current_file=="room_add.php") echo "active" ?>">
                    <a href="room_add.php">
                        <i class="fa fa-wheelchair"></i>
                        <p>Add rooms</p>
                    </a>
                </li>
				<li class="<?php if($current_file=="ambulance.php") echo "active" ?>">
                    <a href="ambulance.php">
                        <i class="fa fa-ambulance"></i>
                        <p>Ambulance Service</p>
                    </a>
                </li>
				<li class="<?php if($current_file=="ambulanceedit.php") echo "active" ?>">
                    <a href="ambulanceedit.php">
                        <i class="fa fa-ambulance"></i>
                        <p>Ambulance Manage</p>
                    </a>
                </li>
